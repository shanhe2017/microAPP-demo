<template>
  <a-drawer v-model:visible="visible" :width="300" placement="right" :closable="false">
    ...
    <div class="margin-bottom: 24px">
      <h3>导航模式</h3>
      <a-radio-group :value="modelValue.layout" @change="(e: any) => updateConf(e.target.value, 'layout')">
      ...
      <a-row style="margin-bottom: 12px">
        ...
        <a-col :span="12" style="text-align: right">
          <a-switch
            ...
            @change="(checked: any) => updateConf(checked === true && undefined, 'headerRender')"
          />
        </a-col>
      </a-row>
      <a-row style="margin-bottom: 12px">
        ...
        <a-col :span="12" style="text-align: right">
          <a-switch
            ...
            @change="(checked: any) => updateConf(checked === true && undefined, 'footerRender')"
          />
        </a-col>
      </a-row>
      <a-row style="margin-bottom: 12px">
        ...
        <a-col :span="12" style="text-align: right">
          <a-switch
            ...
            @change="(checked: any) => updateConf(checked === true && undefined, 'menu')"
          />
        </a-col>
      </a-row>
      <a-row style="margin-bottom: 12px">
        ...
        <a-col :span="12" style="text-align: right">
          <a-switch
            ...
            @change="(checked: any) => updateConf(checked === true && undefined, 'menuHeaderRender')"
          />
        </a-col>
      </a-row>
    </div>
...
const updateConf = (val: string | any | undefined, type: ConfType) => {
  const newVal = {
